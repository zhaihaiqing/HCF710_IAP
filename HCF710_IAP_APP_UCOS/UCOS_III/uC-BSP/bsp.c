...
#define  BSP_BIT_DEM_CR_TRCENA                    DEF_BIT_24			//DWTCR寄存器的第0位，当为1时，是能CYCCNT计数器，使用CYCCNT之前应当先初始化
...
void  BSP_Init (void)
{
    ...
    RCC_PLLConfig(RCC_PLLSource_HSE,							//不倍频
                  RCC_PLLMul_4,
                  RCC_PLLDiv_4);
...
//    switch (led) {
//        case 0:
//             GPIO_ResetBits(GPIOD, (BSP_GPIOD_LED1 | BSP_GPIOD_LED2));
//             break;
...
/*******************************************************************************
* Function Name  : CPU_TS_TmrInit
* Description    : 用来开启和初始化CPU的时间戳定时器，使能DWT和CYCCNT
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : CPU_TS_TmrRd
* Description    : 获取CYCCNT中的值
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : CPU_TS32_to_uSec
* Description    : 将读取到的时钟周期数转换为uS
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
